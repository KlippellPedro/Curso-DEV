...
class Sistema:
    def __init__(self):
        ...
        self.produtos =[
            Produto("Picolé de Abacaxi", 1.25),
            Produto("Picolé de Limão", 2.50),
            Produto("Picolé de Sagu", 5.50),
            Produto("Pote de Açai 2L", 45.50),
            Produto("Pote de Sorvete de Flocos", 19.50),
            Produto("Pote de Sorvete Napolitano", 16.50),
            Produto("Pote de Sorvete de Ovomeltine", 42.99),
            Produto("Picolé do Batman", 900.00),
        ]
        self.caixa= Caixa()
    ...
    def exibir_menu_produtos(self) -> None:
        ...
        for idx, produto in enumerate(self.produtos, start=1):
            print(f"[{idx}] {produto}")
        print("[0] Remover produto do carrinho")
    ...
    def processo_compra(self) -> None:
        ...
        while True:
            ...
            if produto:
                try:
                    qtd= int(input(f"Quantas unidades de '{produto.nome}' deseja adicionar: "))
    ...
    def remover_do_carrinho(self,carrinho: Carrinho) -> None:
        ...
        if carrinho.vazio():
            print("O carrinho está vazio, não há itens para nemover")
            return
        ...
        try:
            opcao = int(input("Escolha o produto que deseja remover: "))
