...
class Sistema:
    ...
    def _inicializar_produtos_exemplo(self):
        self.produtos.append(Produto(100, "Pizza de Calabreza", 25.99, 50, 5))
        self.produtos.append(Produto(201, "Pizza de 4 Queijos", 8.50, 40, 5))
        self.produtos.append(Produto(305, "Pizza de Chocolate", 4.99, 100, 10))
        self.produtos.append(Produto(410, "Pizza de Açai", 6.80, 20, 3))
    ...
    def _adicionar_produto(self):
        ...
        nome = ler_texto("Digite o nome da pizza: ")
        preco = ler_float("Digite o preço unitário: ")
