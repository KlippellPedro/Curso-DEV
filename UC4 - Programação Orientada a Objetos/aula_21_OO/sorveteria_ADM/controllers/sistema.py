...
class Sistema:
    def __init__(self):
        self.produtos: list[Produto] = [
            Produto(1, "Sorvete brigadeiro 1lt", 20.00, estoque=10),
            Produto(2, "Sorvete chocolate 1lt", 20.00, estoque=10),
            Produto(3, "Sorvete açaí 1lt", 25.00, estoque=10),
            Produto(4, "Sorvete flocos 2lt", 30.00, estoque=10),
            Produto(5, "Sorvete ninho trufado 2lt", 35.00, estoque=10),
            Produto(6, "Sorvete chocolate fitness 3lt", 65.00, estoque=10),
            Produto(7, "Sorvete chocolate pra dieta 5lt", 100.00, estoque=10),
            Produto(8, "Poupa do açaí 1lt", 20.00, estoque=10)
        ]
        self.caixa = Caixa()
    ...
    def adicionar_produto_interativo(self):
        ...
        try:
            ...
            preco = float(input("Preço unitário (ex: 4.50): "))
