...
def calcular():
    ...
    # Vale transporte - desconto de 6% sobre o salário bruto, limitado ao valor recebido
    desconto_vt_calclado= salario_bruto*0.06
    desconto_vt= min(desconto_vt_calclado,vale_transporte)
    ...
    return render_template("resultado.html", valor_hora=valor_hora,horas_trabalhadas=horas_trabalhadas,salario_bruto=salario_bruto,aliquota=aliquota,desconto_inss=desconto_inss,desconto_va=desconto_va,desconto_vt=desconto_vt,salario_liquido=salario_liquido)
