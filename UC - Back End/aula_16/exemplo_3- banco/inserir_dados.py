...
cursor.execute("""INSERT INTO clientes (nome_dono, telefone, email) VALUES (?,?,?)
...
# cliente id=1,
cursor.execute("""INSERT INTO pets (nome_pet, especie, cor_pelo, idade, cliente_id) VALUES (?,?,?,?,?)
""", ("Rex", "Cachorro", "branco",3,2))
